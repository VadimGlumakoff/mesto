...
const profileCloseButton = document.querySelector(".popup_close_profile");
const profileForm = document.querySelector(".popup_form_edit");
const addCardForm = document.querySelector('.popup_form_add');
